...
st.set_page_config(page_title="Physician Profile Viewer V6", layout="wide")
...
st.markdown("<h1 style='font-weight:700;'>📘 Physician Profile Viewer – V6</h1>", unsafe_allow_html=True)
